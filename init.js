...
Bot.on("messageCreate", msg => {
    ...
    switch(c){
    	...
    	case "shutdown":
       	...
       	arch.then(mesg => Bot.channels.cache.get("948818170628698182").send(mesg.author.username + " in " + mesg.guild.name + " at <#" + mesg.channel.id + ">: " + mesg.content + " (uploaded by <@" + msg.author.id + ">)"));
